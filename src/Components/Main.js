...
const Main = ({weather}) =>{
    ...
    const air_con = (num) =>{
        if (num === 1){
            return (<p><img className="air__level_img" src={one} alt={one}></img>Good</p>)
        } else if (num=== 2) {
            return (<p><img className="air__level_img" src={two} alt={two}></img>Moderate</p>)
        } else if (num===3){
            return (<p><img className="air__level_img" src={three} alt={three}></img>Unhealthy for sensitive group</p>)
        } else if (num === 4){
            return (<p><img className="air__level_img" src={four} alt={four}></img>Unhealthy</p>)
        } else if (num === 5){
            return (<p><img className="air__level_img" src={five} alt={five}></img>Very Unhealthy</p>)
        } else if (num === 6){
            return (<p><img className="air__level_img" src={six} alt={six}></img>Hazardous</p>)
        }
    }
                    ...
                    <div className="main__cards fourth__cards animate__animated animate__fadeInDown">
                        ...
                        <div className="fourth__card_grid">
                            ...
                            <div className="third__grid">
                                ...
                                <p className="third__grid_info">{weather?.forecast?.forecastday[0].astro.moon_phase}</p>
                            </div>
                            <div className="third__grid">
